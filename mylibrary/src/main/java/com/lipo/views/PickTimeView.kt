...
class PickTimeView : LinearLayout, NumberPicker.OnValueChangeListener {
    ...
    private fun generateView() {
        ...
        mMinuteTip!!.text = ":"
        mNpLeft!!.descendantFocusability = ViewGroup.FOCUS_BLOCK_DESCENDANTS
        mNpMiddle!!.descendantFocusability = ViewGroup.FOCUS_BLOCK_DESCENDANTS
        mNpRight!!.descendantFocusability = ViewGroup.FOCUS_BLOCK_DESCENDANTS
        ...
        mNpLeft!!.layoutParams = params
        params.setMargins(dip2px(mOffsetMargin), 0, 0, 0)
        mNpMiddle!!.layoutParams = params
        mNpRight!!.layoutParams = params
    ...
    private fun initPicker() {
        ...
        mNpLeft!!.minValue = 0
        mNpLeft!!.maxValue = DATA_SIZE - 1
        updateLeftValue(mTimeMillis)

        mNpMiddle!!.minValue = 0
        mNpMiddle!!.maxValue = DATA_SIZE - 1
        updateMiddleValue(mTimeMillis)

        mNpRight!!.minValue = 0
        mNpRight!!.maxValue = DATA_SIZE - 1
    ...
    private fun updateLeftValue(timeMillis: Long) {
        ...
        mNpLeft!!.displayedValues = str
        mNpLeft!!.value = DATA_SIZE / 2
    ...
    private fun updateMiddleValue(timeMillis: Long) {
        ...
        mNpMiddle!!.displayedValues = str
        mNpMiddle!!.value = DATA_SIZE / 2
    ...
    private fun updateRightValue(timeMillis: Long) {
        ...
        mNpRight!!.displayedValues = str
        mNpRight!!.value = DATA_SIZE / 2
