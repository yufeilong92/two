...
//                imageUri = Uri.fromFile(outputImage)
                imageUri = FileProvider.getUriForFile(mActivity, "com.zzzh.akhalteke_shipper.FileProvider", outputImage)
    ...
    fun createImageFile(mActivity: Activity): File {
        ...
        val storageDir = getOwnCacheDirectory(mActivity, "zzzh" + File.separator + "takePhone")//创建保存的路径
