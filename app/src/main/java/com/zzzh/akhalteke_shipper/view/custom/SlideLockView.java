package com.zzzh.akhalteke_shipper.view.custom;
        ...
        viewDragHelper = ViewDragHelper.create(this, 1.0f, new ViewDragHelper.Callback() {
            ...
            public void onViewReleased(View releasedChild, float xvel, float yvel) {
                ...
                if (movedDistance >= getWidth() * unlockTriggerValue) {
                    ...
                    if (mSlippingListenter != null) {
                        mSlippingListenter.endSlipping();
                    }
                } else {
                    //回到起点
                    animToXToPosition(releasedChild, 0, animationTimeDuration);
                    if (mSlippingListenter != null) {
                        mSlippingListenter.startSlipping();
                    }
                }
            }
...
//        canvas.drawRoundRect(mRoundRect, round, round, mPaint);
    ...
    //滑动监听
    public interface Slipping {
        public void startSlipping();

        public void endSlipping();
    }

    private Slipping mSlippingListenter;

    public void setmSlippingListenter(Slipping mSlippingListenter) {
        this.mSlippingListenter = mSlippingListenter;
    }
}
